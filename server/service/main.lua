...
fish.start(function ()
	...
	startup.start(1,7777,9999,"127.0.0.1:10105",nil,"./server/pb")
	...
	remote.forward_gate_name(remote_client,"remote_test","ping",{a = 1,b = 2})
	remote.forward_gate(remote_team,remote_test,"req",{handle = remote_test,c = 3,b = 4})
